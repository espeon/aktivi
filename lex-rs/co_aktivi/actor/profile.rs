...
//
// Lexicon: co.aktivi.actor.profile
//
...
pub struct Profile<'a> {
    /// Small image to be displayed next to posts from account.
...
impl jacquard_common::types::collection::Collection for Profile<'_> {
    const NSID: &'static str = "co.aktivi.actor.profile";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Profile<'a> {
    fn nsid() -> &'static str {
        "co.aktivi.actor.profile"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_co_aktivi_actor_profile()
    }
    fn validate(
        &self,
...
fn lexicon_doc_co_aktivi_actor_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("co.aktivi.actor.profile"),
        revision: None,
        description: None,
        defs: {
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Record(::jacquard_lexicon::lexicon::LexRecord {
                    description: Some(
                        ::jacquard_common::CowStr::new_static("A user profile."),
                    ),
