...
//
// Lexicon: co.aktivi.actor.defs
//
// This file was automatically generated from Lexicon schemas.
// Any manual changes will be overwritten on the next regeneration.

pub mod get_events;
pub mod get_profile_view;
pub mod get_rsv_ps;
    ...
    S::Did: profile_view_state::IsSet,
{
    ...
    pub fn build(self) -> ProfileView<'a> {
        ProfileView {
            ...
            handle: self.__unsafe_private_named.5,
            indexed_at: self.__unsafe_private_named.6,
            rsvp_count: self.__unsafe_private_named.7,
...
fn lexicon_doc_co_aktivi_actor_defs() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("co.aktivi.actor.defs"),
        revision: None,
        description: None,
        defs: {
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for ProfileView<'a> {
    fn nsid() -> &'static str {
        "co.aktivi.actor.defs"
    }
    fn def_name() -> &'static str {
        "profileView"
    }
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_co_aktivi_actor_defs()
    }
    fn validate(
        &self,
